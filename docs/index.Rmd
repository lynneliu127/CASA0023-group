...
### 3. Problem: Context & Background
### 4. Problem: Context & Background
### 5. Problem: Context & Background
### 6. Problem: Context & Background
...
-  However, extended periods of **drought can reduce the soil's water absorption**.
---
...
### However, 
### one of the biggest predictors of flood susceptibility 
### is 
...
- Urban areas are more prone to flooding than rural areas. **Buildings can worsen the situation**. 

- The trapped water has less surface area to accumulate, leading to higher water levels.

- **Changes in landform may** cause rainfall from elsewhere to flow into the area, **increasing the volume of water**, while also limiting where floodwaters can disperse.
